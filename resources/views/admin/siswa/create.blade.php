...
<div class="p-6 space-y-6 animate-fade-in">
    <div class="mb-2">
        <h1 class="text-2xl font-black text-gray-800 tracking-tight uppercase">Tambah Siswa Baru</h1>
        <p class="text-xs font-bold text-gray-400 mt-1 uppercase tracking-widest">Pendaftaran Peserta Didik Baru SMAN 1 Jejangkit</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden border-t-4 border-t-blue-600">
        <div class="p-5 border-b border-gray-50 bg-gray-50/30">
            <h3 class="text-xs font-black text-gray-500 uppercase tracking-widest flex items-center gap-2">
                <i class="fa-solid fa-user-plus text-blue-600"></i> Formulir Biodata Siswa
            </h3>
        </div>

        <form action="{{ route('admin.siswa.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
