...
<div class="p-4 space-y-4 animate-fade-in">
    ...
    <div class="px-1">
        ...
        <p class="text-[8px] text-slate-400 font-bold uppercase tracking-[0.1em] mt-1">Manajemen Ruang Kelas SMAN 1 Jejangkit</p>
    </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div class="p-4 border-b border-slate-50 bg-slate-50/30">
            <h3 class="text-[9px] font-black text-slate-500 uppercase tracking-widest flex items-center gap-2">
                <i class="fa-solid fa-folder-plus text-blue-600 text-[10px]"></i> Registrasi Kelas Baru
            </h3>
        </div>
        ...
        <form action="{{ route('admin.kelas.store') }}" method="POST" class="p-6 md:p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
                ...
                {{-- Pilih Wali Kelas --}}
                <div class="group">
                    <label class="block text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-0.5 group-focus-within:text-blue-600 transition-colors">Wali Kelas (Opsional)</label>
                    <div class="relative">
                        <select name="guru_id" class="w-full px-4 py-2 rounded-lg border border-slate-200 bg-slate-50/30 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 text-xs font-black transition-all outline-none appearance-none cursor-pointer text-slate-700 uppercase tracking-wider">
            ...
            {{-- Info Tip --}}
            <div class="mt-4 bg-blue-50/50 p-3 rounded-lg border border-blue-100 border-dashed flex items-center gap-3">
                <i class="fa-solid fa-lightbulb text-blue-500 text-[10px]"></i>
                <p class="text-[8px] text-blue-700 font-black uppercase tracking-wider leading-tight">
