...
<div class="p-4 space-y-4 animate-fade-in">
    {{-- Header Section - Dikecilkan kembali agar tidak makan ruang --}}
        ...
        <form action="{{ route('admin.guru.store') }}" method="POST" class="p-5 md:p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
                ...
                <div class="md:col-span-2 group">
                    <label class="block text-[9px] font-black text-slate-400 uppercase tracking-[0.1em] mb-1 group-focus-within:text-blue-600">Nama Lengkap & Gelar</label>
                    <div class="relative">
                        ...
                        <i class="fa-solid fa-user-tie absolute right-4 top-2.5 text-slate-300 text-[10px] pointer-events-none group-focus-within:text-blue-500"></i>
                    </div>
                </div>

                {{-- NIP --}}
                <div class="group">
                    <label class="block text-[9px] font-black text-slate-400 uppercase tracking-[0.1em] mb-1 group-focus-within:text-blue-600">NIP / Identitas</label>
                    <div class="relative">
                        <input type="text" name="nip" placeholder="NOMOR INDUK PEGAWAI" value="{{ old('nip') }}"
                               class="w-full px-4 py-2 rounded-lg border border-slate-200 bg-slate-50/30 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 text-xs font-bold transition-all outline-none uppercase placeholder:text-slate-300" required>
                        <i class="fa-solid fa-id-card absolute right-4 top-2.5 text-slate-300 text-[10px] pointer-events-none group-focus-within:text-blue-500"></i>
                    </div>
                </div>

                {{-- Email --}}
                <div class="group">
                    <label class="block text-[9px] font-black text-slate-400 uppercase tracking-[0.1em] mb-1 group-focus-within:text-blue-600">Email Akun</label>
                    <div class="relative">
                        ...
                        <i class="fa-solid fa-envelope absolute right-4 top-2.5 text-slate-300 text-[10px] pointer-events-none group-focus-within:text-blue-500"></i>
                    </div>
                </div>
            </div>

            {{-- Info Tip Ramping --}}
            <div class="mt-5 bg-blue-50/50 p-3 rounded-lg border border-blue-100 border-dashed flex items-center gap-3">
                <i class="fa-solid fa-shield-halved text-blue-500 text-[10px]"></i>
                <p class="text-[9px] text-blue-700 font-bold uppercase tracking-wider">
            ...
            <div class="mt-6 pt-4 flex justify-end items-center gap-3 border-t border-slate-100">
                <a href="{{ route('admin.guru.index') }}" 
                   class="px-6 py-2 rounded-lg text-[10px] font-black text-white bg-rose-600 hover:bg-rose-700 transition-all uppercase tracking-widest active:scale-95 shadow-sm shadow-rose-100 text-center">
                    Batal
                </a>
                
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-black py-2 px-8 rounded-lg shadow-sm transition-all active:scale-95 uppercase tracking-widest text-[10px]">
                    Simpan Data
                </button>
            </div>
        </form>
