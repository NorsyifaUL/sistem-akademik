...
<div class="p-4 space-y-4 animate-fade-in">
    ...
    <div class="flex items-end justify-between px-1">
        <div>
            <h2 class="text-base font-black text-slate-800 tracking-tight uppercase leading-none">Tambah <span class="text-blue-600">Mata Pelajaran</span></h2>
            <p class="text-[8px] text-slate-400 font-bold uppercase tracking-[0.1em] mt-1">Manajemen Kurikulum SMAN 1 Jejangkit</p>
        </div>
    </div>
    ...
    <div class="w-full bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div class="p-4 border-b border-slate-50 bg-slate-50/30">
            <h3 class="text-[9px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2">
                <i class="fa-solid fa-file-signature text-blue-600"></i> Form Input Data Baru
            </h3>
        </div>
        ...
        <form action="{{ route('admin.mapel.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="bg-blue-50/50 rounded-xl border border-blue-100 border-dashed p-4 flex items-center gap-4">
                    ...
                    <div>
                        <h4 class="text-[10px] font-black text-blue-800 uppercase tracking-tight">Informasi</h4>
                        <p class="text-[9px] text-blue-500 font-bold leading-tight uppercase opacity-80 mt-0.5">
                            Nama mata pelajaran akan tampil di Jadwal, Absensi, dan Raport. Pastikan penulisan sesuai dengan nomenklatur kurikulum.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="pt-6 border-t border-slate-50 flex justify-between items-center gap-4">
                ...
                <button type="submit" 
                    ...
                    <i class="fa-solid fa-floppy-disk"></i> Simpan Mata Pelajaran
                </button>
            </div>
        </form>
    </div>
